package com.sh303.springmvc.handlers;

import com.sh303.springmvc.entities.User;
...
public class SpringMVCTest {
    ...
    public String testSessionAttributes(Map<String, Object> map){
        User user = new User("Tom", "123456", "Tom@atguigu.com", 13);
        map.put("user", user);
    ...
    /**
     * Spring MVC 会案请求参数和 POJO 属性名自动匹配
     * 自动为该对象填充属性值。支持级联属性
    ...
    public String testRequestParam(@RequestParam(value = "username", required = false, defaultValue = "zhangsan") String username,
        ...
        System.out.println("testRequestParam GET: username = " + username + " age = " + age);
        return SUCCESS;
    }
     ...
     * 2.需要发送POST 请求
     * 3.需要在发送POST 请求时携带一个 name="_method" 的隐藏域，值为 DELETE 和 PUT
     * <p>
     ...
     * @param id
     * @return String
     * @PathVariable(value = {id})   可
     * <p>
     * 以来映射 URL中的占位符到目标方法的参数中
     */
